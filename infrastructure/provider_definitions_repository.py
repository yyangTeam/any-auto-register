...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "label": "本地邮箱池",
        "description": "导入本地账号池：微软邮箱保持原心蓝/OAuth/IMAP 逻辑，iCloud 支持接码链接和 FlySMS 取件协议",
        ...
        "fields": [
            {
                ...
                "category": "connection",
                "hint": "可选；每行一条账号。微软支持心蓝邮箱助手通用格式；iCloud 支持 email@icloud.com----https://...，连续 3 个及以上短横线都可作为分隔符。",
            },
            {
                ...
                "type": "textarea",
                "category": "auth",
                "hint": "可选；直接粘贴账号池。微软支持逗号、中文逗号、TAB 或连续 3 个及以上短横线分隔；iCloud 每行格式：邮箱----接码地址，支持 FlySMS 取件链接。",
            },
            {
